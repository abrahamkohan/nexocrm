  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <div className="flex flex-col gap-4">
        <div className="grid grid-cols-2 gap-3">
          <HeroCard label="Ganancia neta / mes" value={formatUsd(result.ganancia_neta_mensual)} color="#0f766e" />
          <HeroCard label="Rentabilidad anual" value={`${result.rentabilidad_percent.toFixed(1)}%`} color="#0f766e" />
        </div>
