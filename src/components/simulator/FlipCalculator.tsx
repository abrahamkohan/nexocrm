    ...
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <div className="flex flex-col gap-4">
        <div className="grid grid-cols-2 gap-3">
          <HeroCard label="Neto para inversor" value={formatUsd(result.neto_inversor)} color="#d97706" />
          <HeroCard label="ROI anualizado" value={`${result.roi_anualizado.toFixed(1)}%`} color="#d97706" />
        </div>
